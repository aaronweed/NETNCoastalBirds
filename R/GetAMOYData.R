...
GetAMOYData<-function(x,  ODBC_connect = TRUE, export = FALSE){
  ...
  #names(temp.amoy2)
  ## subset df to final 
  AMOY_raw<-temp.amoy2[,c("Park", "Island","Segment", "Survey_Class" , "Survey_Type","Date","Start_Time", "year", "month", "Obs_Type","Species_Code" ,"Group_Time",
                          "Group_NewTerritory","Group_Notes", "Group_Coords", "Species_Unit","Unit_Count" ,"Wind_Direction","Wind_Speed","Air_Temp_F","Cloud_Perc","Tide_Stage")] 
