#'  Ground-based nest survey data summarized by island and year
#' 
...
#'  \item{variable}{Life stage surveyed; Nests, Chicks, ChicksPerNest,Eggs, EggsPerNest}
#'  \item{Count_Method}{Denotes whether nests were directly counted or estimated by another method; "Direct Count )}
