...
GetNestData <- function(connect = "ODBC", DBfile = NULL, export = FALSE) {
  ...
  nest_surveys_raw <- select(temp.nest, Park, Island, Segment, Survey_Class,
                                    ...
                                    Latitude, Longitude, Obs_Notes, Survey_Notes, Wind_Direction, 
  ...
  if (export == TRUE) {
    ...
    nest_surveys_raw <- select(temp.nest, Park, Island, Segment, Survey_Class,
                               ...
                               Latitude, Longitude, Obs_Notes, Survey_Notes, Wind_Direction, Wind_Speed, Air_Temp_F, Cloud_Perc, Tide_Stage)  
