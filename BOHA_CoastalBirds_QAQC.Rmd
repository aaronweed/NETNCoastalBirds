...
y2<- PlotBirds( filter(creche,!variable == "Average creche size"), year= params$year, island ="All Islands", raw_count = T, stat = "sum", legend= F, facet= "variable", print= FALSE)

(y2 + scale_color_manual(values = c("black","darkgray", "blue"))) + labs(title= "Daily Counts of Common Eider (COEI) per lifestage across all Outer Islands")
...
0VAR<-unique(creche_y$variable); VAR<-set_names(VAR, nm=VAR)
