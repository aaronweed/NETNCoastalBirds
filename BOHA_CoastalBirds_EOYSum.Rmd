...
a<-PlotBirds(creche, year= params$year, raw_count = T, stat = "sum", legend= T, var= c("COEI Ducklings" ,"Adult female COEI tending"))
...
cols_2 <- c("black", "darkblue", "darkgray")

PlotBirds( creche, year= params$year, island ="All Islands", raw_count = T, stat = "sum", legend= F, facet= "variable")+ scale_color_manual(values= cols_2)
